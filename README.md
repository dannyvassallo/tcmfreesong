...
```shell
git clone https://github.com/dannyvassallo/tcmfreesong.git
cd tcmfreesong
```

From the "tcmfreesong" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "tcmfreesong" directory use this command:
```shell
middleman s
```
